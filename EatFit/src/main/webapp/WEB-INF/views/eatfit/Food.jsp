...
<nav class="shadow fixed-top mb-2 bg-white">
  ...
  <section class="container only-center">
    <img src="/image/RO.png" class="robot">
  </section>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  <footer class="container-fluid main-footer bg-white footer">
    ...
    <a class="col-4 m-0 only-center" id="nav-this" href="/html/Food.html">식자재 보관함</a>
  
    <a class="col-4 m-0 only-center" href="/html/LoginMain.html">오늘의 잇-핏</a>
