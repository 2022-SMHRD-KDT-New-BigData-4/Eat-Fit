...
<nav class="shadow fixed-top mb-2 bg-white">
  ...
  <section class="container mt9">
    <div class="row ht37">
    <div class="sec_cal p-0 shadow cal-content">
  ...
  <div class="con-12 text-center fw-bold fs-5 mt-5">날짜를 클릭하여 식단을 확인하세요!</div>
  ...
  <section class="container">
    <div class="row">
      <div class="col-12">
      <div class="fw-bold ms-4 click-day" style="font-size: 25px; ">
      </div>
      </div>
  ...
  <footer class="container-fluid main-footer bg-white footer">
    ...
    <a class="col-4 m-0 only-center" href="/html/LoginMaincopy.html">오늘의 잇-핏</a>
